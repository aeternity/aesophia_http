...
```
curl -H "Content-Type: application/json" -d "{\"source\":\"$contract\",\"function\":\"init\", \"call-result\":\"ok\", \"call-value\":\"cb_AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKsxo1JY=\"}" -X POST http://localhost:3080/decode-call-result
```
